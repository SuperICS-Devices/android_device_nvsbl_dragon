...
# Update Me
PRODUCT_COPY_FILES += \
	device/nvsbl/dragon/prebuilt/app/UpdateMe.apk:system/app/UpdateMe.apk \
	device/nvsbl/dragon/prebuilt/update_me.xml:system/update_me.xml

# /system/bin
PRODUCT_COPY_FILES += \
	device/nvsbl/dragon/prebuilt/bin/fsck.exfat:system/bin/fsck.exfat \
	device/nvsbl/dragon/prebuilt/bin/mkfs.exfat:system/bin/mkfs.exfat \
	device/nvsbl/dragon/prebuilt/bin/mount.exfat:system/bin/mount.exfat \
	device/nvsbl/dragon/prebuilt/bin/ntfs-3g:system/bin/ntfs-3g \
	device/nvsbl/dragon/prebuilt/bin/ntfs-3g.probe:system/bin/ntfs-3g.probe \
	device/nvsbl/dragon/prebuilt/bin/mkntfs:system/bin/mkntfs \
...
PRODUCT_COPY_FILES += \
	...
	device/nvsbl/dragon/prebuilt/etc/ppp/ip-up:system/etc/ppp/ip-up \
	device/nvsbl/dragon/prebuilt/etc/ppp/call-pppd:system/etc/ppp/call-pppd \
	device/nvsbl/dragon/prebuilt/etc/firmware/ath3k-1.fw:system/etc/firmware/ath3k-1.fw \
	device/nvsbl/dragon/prebuilt/etc/firmware/ath3k-1.fw:system/vendor/firmware/ath3k-1.fw \
...
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/nvsbl/dragon/prebuilt/etc/init.d,system/etc/init.d)

PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/nvsbl/dragon/prebuilt/etc/usb_modeswitch.d,system/etc/usb_modeswitch.d)
...
# /system/usr
PRODUCT_COPY_FILES += \
	device/nvsbl/dragon/prebuilt/usr/idc/ft5x_ts.idc:system/usr/idc/ft5x_ts.idc \
	device/nvsbl/dragon/prebuilt/usr/idc/Goodix-TS-board-3.idc:system/usr/idc/Goodix-TS-board-3.idc \
	device/nvsbl/dragon/prebuilt/usr/keylayout/axp20-supplyer.kl:system/usr/keylayout/axp20-supplyer.kl \
	device/nvsbl/dragon/prebuilt/usr/keylayout/sun4i-keyboard.kl:system/usr/keylayout/sun4i-keyboard.kl
